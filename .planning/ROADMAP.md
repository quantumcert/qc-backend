...
- [ ] **Phase 2: Document Verification + QTAG Production** _(3 plans ready)_ — Verificação pública de documentos e NFC commissioning funcionando em produção
...
**Wave 1**
  - [ ] 02-01-PLAN.md — Public document verification + qc-record-module bridge idempotency: DOC-01, DOC-02, DOC-03

**Wave 2** *(blocked on Wave 1 completion)*
  - [ ] 02-02-PLAN.md — QTAG production commissioning with tenant-scoped KMS material: QTAG-01

**Wave 3** *(blocked on Wave 2 completion)*
  - [ ] 02-03-PLAN.md — Suspicious QTAG scan verification and audit trail: QTAG-02
...
| 2. Document Verification + QTAG Production | [M#2](https://github.com/quantumcert/qc-backend/milestone/2) | #12, #2 | 0/3 | Ready to execute | - |
